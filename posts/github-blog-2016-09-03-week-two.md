...
Being assigned 2 coding-based projects is overwhelming; Learning to deal with errors such as pull request fails on branches between Travis-CI and github, developing code for a project in C++, a language I only learned about a week and a half ago, and having a 24/7 hour partner project where I have to create a mini-shell with command line features takes up a lot of time.
