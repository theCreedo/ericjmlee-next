...
reading_time: 2
description: >-
  Wrapping up OS Project 3 and the OOP Life project, narrowly missing a bike at
  a silent auction, and mixed feelings about the semester ending.
topics:
  - college
  - craft
---

> CS371p — Object-Oriented Programming in C++ (Fall 2016), UT Austin, taught by Professor Downing. First published at [thecreedo.github.io](https://thecreedo.github.io/Chill-ish-Week/).
...
The Life project was pretty smooth. We went off of our Object-Oriented design from last week on Tuesday, and ended up finishing the project in less than 3 days. It still amazes me that for most of the projects for OOP, the hard part was creating a design for the code. Implementing and going through the development process was Ezpz.
...
Next week will be a continuation of work on file systems. (Oh Pintos, this'll be our last prolonged time together)
