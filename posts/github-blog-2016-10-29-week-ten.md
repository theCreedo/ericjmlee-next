...
Additionally, I plan to go to [Indigitous Hack](https://indigitous.org/hack/). That'll be good, because it'll be a time where I can attempt to use the skills I have in Computer Science for a faith-based cause. There are a lot of challenges that need to be created, and I'm looking forward to what I can give during that time.
